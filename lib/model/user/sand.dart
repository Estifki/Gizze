...
class SandModel {
  ...
  factory SandModel.fromJson(Map<String, dynamic> json) => SandModel(
        ...
        status: json["status"],
        data: List<HomeSandData>.from(
            json["data"].map((x) => HomeSandData.fromJson(x))),
      );
...
class HomeSandData {
  ...
  factory HomeSandData.fromJson(Map<String, dynamic> json) => HomeSandData(
        id: json["id"],
        name: json["name"],
